    ...
    <legend class="flex items-center gap-2 text-base font-bold text-gray-800 px-2">
     Asistencia fuera de casa (Opcional)
      <button
        ...
        title="¿Qué es la asistencia fuera de casa?"
        class="inline-flex items-center justify-center w-5 h-5 rounded-full bg-teal-100 hover:bg-teal-200 text-teal-600 transition-colors"
      >
